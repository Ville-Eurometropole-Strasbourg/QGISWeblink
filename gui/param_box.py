...
from QGISWeblink.nodes.tree_node_factory import TreeNodeFactory
from QGISWeblink.nodes.tree_node_factory import download_tree_config_file
...
class ParamBox(QDialog):
    ...
    def init_gui(self):
        ...
        self.use_auth_config = QCheckBox(u"Accès WMS authentifié", self)
    ...
    def set_values_from_qsettings(self):
        ...
        self.use_auth_config.setChecked(
            PluginGlobals.instance().USE_AUTH_CONFIG
        )
    ...
    def evaluate_flags(self):
        ...
        use_auth_config_changed = (
            self.use_auth_config.isChecked()
            != PluginGlobals.instance().USE_AUTH_CONFIG
        )
