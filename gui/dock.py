...
from QGISWeblink.gui.tree_widget import TreeWidget


class DockWidget(QDockWidget):
    """
    The dock widget containing the tree view displaying the qgis web resources
    """
    ...
    def init_gui(self):
        """
        """
        self.setWindowTitle(u'QGISWeblink: acces à QGIS WEB')
