...
from QGISWeblink.utils.singleton import Singleton
...
class PluginIcons():
    ...
    def __init__(self):
        ...
        qlr_layer_icon_path = os.path.join(PluginGlobals.instance().images_dir_path,
                                           PluginGlobals.instance().ICON_QGIS_QLR_FILE_NAME)
        self.qlr_layer_icon = QIcon(qlr_layer_icon_path)
