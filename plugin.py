...
from QGISWeblink.gui.dock import DockWidget
from QGISWeblink.gui.about_box import AboutBox
from QGISWeblink.gui.param_box import ParamBox
...
class SimpleAccessPlugin:
    ...
    def createPluginMenu(self):
        ...
        self.plugin_menu = QMenu(u"QGISWeblink intranet EMS", plugin_menu)
